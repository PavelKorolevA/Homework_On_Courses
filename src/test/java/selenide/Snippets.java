...
public class Snippets {
    ...
    void selectors_examples() {
        ...
        $("div", 2).click(); // ищет 3-ий по счету див(нумерация с 0)
        ...
        $("").closest("div"); // ищем предка имеющий тэг див
    ...
    void actions_examples() {
        ...
        actions().sendKeys(Keys.chord(Keys.CONTROL, "f")).perform(); // комбинации клавиш Ctrl + F
